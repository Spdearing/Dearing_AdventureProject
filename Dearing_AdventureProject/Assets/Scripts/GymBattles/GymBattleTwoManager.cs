...
/// <summary>
/// Handles the UI data initialization for GymBattleTwo
/// </summary>

public class GymBattleTwoManager : MonoBehaviour
{
    public static GymBattleTwoManager Instance;
    ...
    private void Awake()
    {
        ...
        enemyCreature = EnemyCreature.Create("Laxerous", 20, 10, false);
        friendlyCreature = FriendlyCreature.Create("Rexasourus", 20, 10, 20, 15, 10, false);

        //Creation of Enemy, and Friendly Items
        potion = PlayerItems.Create("Potion", 10, 0, 5);
        aPBoost = PlayerItems.Create("APBoost", 0, 6, 5);
    }
    ...
    public void UpdateHealthAndNameText()
    {
        ...
        enemyHealth.text = "HP: " + enemyCreature.GetEnemyHealth() + "/20";
        friendlyName.text = friendlyCreature.GetFriendlyName();
        friendlyHealth.text = "HP: " + friendlyCreature.GetFriendlyHealth() + "/20";
    }
