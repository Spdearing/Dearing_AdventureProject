...
public class UsingItems : MonoBehaviour
{
    ...
    public void UsingPotion()
    {
        if(SceneManager.GetActiveScene().name == "GymBattleOne")
        {
            int healingAmount = GymBattleOneManager.Instance.ReturnPotion().GetHealing();//this number is the PlayerItem class script, and it is the second element of the object after the name
